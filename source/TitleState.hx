...
class TitleState extends MusicBeatState
{
	...
	var titlemenubg:FlxSprite;
	var credGroup:FlxGroup;
	var credTextShit:Alphabet;
	var textGroup:FlxGroup;
	
	var titleTextColors:Array<FlxColor> = [0xFFFA569D, 0xFFAE19B1];
...
//	var danceLeft:Bool = false;
	...
	function startIntro()
	{
		...
		bg.loadGraphic(Paths.image('menuBG', 'preload'));
		add(bg);

		logoBl = new FlxSprite(175, -39);
...
//		gfDance = new FlxSprite(titleJSON.gfx, titleJSON.gfy);
		...
		titlemenubg = new FlxSprite(0, 0);
		titlemenubg.loadGraphic(Paths.image('menuBG', 'preload'));
		credGroup.add(titlemenubg);
