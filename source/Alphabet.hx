...
class Alphabet extends FlxSpriteGroup
{
	...
	public var soundOverride:Bool = false;
	public function new(x:Float, y:Float, text:String = "", ?bold:Bool = false, typed:Bool = false, ?typingSpeed:Float = 0.05, ?textSize:Float = 1, ?soundOverride:Bool = false)
	{
		super(x, y);
